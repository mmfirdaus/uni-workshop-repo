...
<div class="main">
	<h2>DETAILS<a href = "addalbumform.php" class = "button">ADD ALBUM</a><a href = "searchdetailstaff.php" class = "button">SEARCH ALBUM</a><a href = "updatealbumform.php" class = "button">UPDATE ALBUM</a></h2>
	<?php
...
if (mysqli_num_rows($result) > 0) {
	...
	while ($row = mysqli_fetch_array($result))
	{
		...
		echo $row["price"];
		echo "</TD><TD style='width:200px;font-size:40px'>";
		echo "<a href=\"deletealbumconfirm.php?id=".$row["album_id"]."\">Delete</a></TD></TR>";
