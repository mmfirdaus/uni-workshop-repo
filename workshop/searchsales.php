...
<h2>REPORT</h2>
<h3>Album Sales
<a href='salesreport.php' class= button>BACK</a></h3>
...
echo"<h3>Sales From  '$fromdate'  To  '$todate'</h3>";
...
$sqla = "select sum(amount) as sum from sale where purchase_date between '$fromdate' and '$todate'";
