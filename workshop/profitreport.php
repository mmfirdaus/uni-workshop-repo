...
while ($row = mysqli_fetch_array($result))
{
	...
	$sql2 = "select sum(amount) from sale where album_id ='".$row["album_id"]."'";
...
$sqla = "select sum(sale.amount*album.price) as sum from sale join album on sale.album_id=album.album_id";
...
?>
<form method="post" action="searchprofit.php">
<h3> Search </h3>
<label> From </label>
</br>
